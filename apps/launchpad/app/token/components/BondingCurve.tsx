  ...
  return (
    <div className="flex flex-col gap-y-3">
      ...
      <p className="text-white mb-1">
        when the market cap reaches $6000 all the liquidity from the bonding
        curve will be deposited into Hydration and burned. progression increases
        as the price goes up.
      </p>
      <p className="text-white">
        there are {formatBnBalance(totalAvailable, { numberAfterComma: 2 })}{" "}
        tokens still available for sale in the bonding curve and there is{" "}
        {formatBnBalance(reserveBalance, { numberAfterComma: 2 }, network)} BNB
