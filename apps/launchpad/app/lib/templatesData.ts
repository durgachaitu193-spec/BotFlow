import { Bot, Database, Github, Globe, Mail, MessageSquare, Search, Youtube } from 'lucide-react'
...
export const templates: Template[] = [
  {
    ...
    description: 'Analyze a landing page and determine its quality with multiple agents',
    author: 'Adam Gough',
    stars: 3,
    forks: 247,
    tags: ['Browser Use', 'Perplexity', 'OpenAI'],
    updatedAt: 'about 2 hours ago',
    credentials: ['API Key for Browser Use', 'Perplexity API Key', 'OpenAI API Key'],
    icon: Globe,
    flowData: {
      nodes: [
        {
  ...
  },
  {
    ...
    description: 'Automatically label emails in Gmail based on their content using AI.',
    author: 'Adam Gough',
    stars: 2,
    forks: 366,
    tags: ['Gmail', 'OpenAI'],
  ...
  },
  {
    ...
    description: 'A chatbot that answers questions using your internal documentation and data.',
    author: 'Adam Gough',
    stars: 0,
    forks: 221,
  ...
  },
  {
    ...
    description: 'Search for YouTube videos on a topic and generate summaries for them.',
    author: 'Adam Gough',
    stars: 2,
    forks: 198,
  ...
  },
  {
    ...
    description: 'Automatically generate release notes and publish releases on GitHub.',
    author: 'Waleed Latif',
    stars: 2,
    forks: 140,
  ...
  },
  {
    ...
    description: 'A basic skeleton for building Retrieval Augmented Generation chat applications.',
    author: 'Adam Gough',
    stars: 0,
    forks: 94,
    tags: ['RAG', 'Skeleton'],
  ...
  },
  {
    ...
    description: 'A personal assistant bot on Telegram to manage your tasks and schedule.',
    author: 'Adam Gough',
    stars: 2,
    forks: 185,
