...
import { ArrowUp, Bell, Library, RefreshCw } from 'lucide-react'
...
export function LogsToolbar({
  ...
  const triggerOptions: ComboboxOption[] = useMemo(
    () =>
      getTriggerOptions().map((t) => ({
        value: t.value,
        label: t.label,
        icon: getTriggerIcon(t.value) || getColorIcon(t.color),
      })),
    []
  )
  ...
  }, [level, workflowIds, folderIds, triggers, timeRange, searchQuery])
  ...
  const handleClearFilters = useCallback(() => {
    ...
    onSearchQueryChange('')
  }, [setLevel, setWorkflowIds, setFolderIds, setTriggers, setTimeRange, onSearchQueryChange])
    ...
    <div className='flex flex-col gap-[19px]'>
      ...
      <div className='flex items-start justify-between'>
        ...
        <div className='flex items-center gap-[8px]'>
          ...
          {/* View mode toggle */}
          <div className='flex h-[32px] items-center rounded-[6px] border border-[var(--border)] bg-[var(--surface-2)] p-[2px]'>
            <Button
